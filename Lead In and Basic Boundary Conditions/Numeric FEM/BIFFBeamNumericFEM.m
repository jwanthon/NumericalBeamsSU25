...
%   for a built in-free free beam using numeric FEM, determines the solution 
...
if FLAG.DISPLAY_MODES
    ...
    title("Mode Shapes of a Built In-Free Free Beam");
end
...
if FLAG.DISPLAY_SPECTRUM
    ...
    title("Adjusted BI-FF Eigenvalue Magnitudes");
